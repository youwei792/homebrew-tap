class Agentsmd < Formula
  ...
  on_macos do
    on_arm do
      ...
      def install
        bin.install "agentsmd_darwin_arm64/agentsmd"
      end
    end
    on_intel do
      ...
      def install
        bin.install "agentsmd_darwin_amd64/agentsmd"
      end
    end
  end
  ...
  on_linux do
    on_arm do
      ...
      def install
        bin.install "agentsmd_linux_arm64/agentsmd"
      end
    end
    on_intel do
      ...
      def install
        bin.install "agentsmd_linux_amd64/agentsmd"
      end
    end
  end
